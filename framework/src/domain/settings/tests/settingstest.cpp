...
private slots:
    ...
    void testLoad()
    {
        ...
        auto carddavPassword = QString("carddavPassword");
        ...
        settings.setProperty("carddavPassword", carddavPassword);
        ...
        //Ensure we can read back all the information using the accountid
        {
            ...
            QCOMPARE(readSettings.property("carddavPassword").toString(), carddavPassword);
        ...
        //Modify all settings
        {
            ...
            settings.setProperty("carddavPassword", carddavPassword + "mod");
        ...
        //Read back settings again
        {
            ...
            QCOMPARE(readSettings.property("carddavPassword").toString(), carddavPassword + "mod");
