...
Item {
    ...
    property string markImportant_inverted: "kubeimportant-inverted"
    property string markUnimportant: "kubeunimportant"
    property string markUnimportant_inverted: "kubeunimportant-inverted"
    property string isImportant: "kubeimportant"
    property string undo: "edit-undo"
    property string undo_inverted: "edit-undo-inverted"
